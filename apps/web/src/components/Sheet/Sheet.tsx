...
interface BottomSheetProps {
  ...
  content: (close: () => Promise<void>) => React.ReactNode
}

export function Sheet({ trigger, content }: BottomSheetProps) {
  ...
  const close = () => new Promise<void>((resolve) => animate(y, 0, { type: 'spring', duration: 0.48, bounce: 0.0, onPlay: () => setIsOpen(false), onComplete: resolve })) // prettier-ignore
